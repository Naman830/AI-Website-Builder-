  ...
  <section className="pt-32 pb-20 relative overflow-hidden">
    ...
    <div className="max-w-[1280px] mx-auto px-6 flex flex-col items-center text-center gap-10">
      ...
      >
        ...
        {/* Main container */}
        <div className="relative bg-surface-dark/85 backdrop-blur-lg border border-border-dark rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.45)] focus-within:border-primary/70 transition-colors duration-200">
          {/* Sparkle icon */}
